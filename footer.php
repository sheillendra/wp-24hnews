            ...
            <div class="container">
                <div class="row no-gutter">
                    <div class="col-sm-6 col-md-3">
                        ...
                        <?php get_template_part('template-parts/header/logo', 'footer'); ?>
                    </div>
                    <div class="col-sm-6 col-md-3">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="item">
                                        <div class="item-image">
                                            <a class="img-link" href="deals.html">
                                                <img class="img-responsive img-full" src="http://localhost/templates/24hNews/img/food_370x185-image05.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="item-content">
                            ...
                            <ul>
                                <li>
                                    <div class="item">
                                        <div class="item-image">
                                            <a class="img-link" href="deals.html">
                                                <img class="img-responsive img-full" src="http://localhost/templates/24hNews/img/art-entertainment_370x185-image04.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="item-content">
                                ...
                                <li>
                                    <div class="item">
                                        <div class="item-image">
                                            <a class="img-link" href="deals.html">
                                                <img class="img-responsive img-full" src="http://localhost/templates/24hNews/img/index_370x185-image16.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="item-content">
